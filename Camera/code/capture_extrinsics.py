...
OUTPUT_ROOT = "calibration/extrinsics"
...
def main() -> None:
	...
	cv2.namedWindow("Capture Extrinsics", cv2.WINDOW_NORMAL)
	...
	try:
		while True:
			...
			if frames:
				...
				cv2.imshow("Capture Extrinsics", preview)
